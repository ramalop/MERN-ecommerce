...
export const getAllOrders = createAsyncThunk("/order/getAllOrders", async (userId) => {
    const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/shop/order/getAllOrders/${userId}`, {})
    return response.data
})
export const getOrderDetails = createAsyncThunk("/order/getOrderDetails", async (id) => {
    const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/shop/order/getOrderDetals/${id}`, {})
    return response.data
})
